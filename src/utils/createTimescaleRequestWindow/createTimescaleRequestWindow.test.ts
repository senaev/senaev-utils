...
import { callTimes } from '../callTimes/callTimes';
...
describe('createTimescaleRequestWindow', () => {
    it('should request normal lastObject', async () => {
        const loadNextObjects = vi.fn<TimescaleRequestWindowLoadNextObjectsFunction<string>>(async ({
            lastObject,
            count,
        }) => {
    ...
    it('should correctly handle limits', async () => {
        const loadNextObjects = vi.fn<TimescaleRequestWindowLoadNextObjectsFunction<number>>(async ({
            lastObject,
            count,
        }) => {
            const nextNumber = lastObject === undefined
    ...
    it('should return isLast=true with empty result if loadNextObjects returns empty object', async () => {
        ...
        const loadNextObjects = vi.fn<TimescaleRequestWindowLoadNextObjectsFunction<number>>(async () => new Promise((resolve) => {
