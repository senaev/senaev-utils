...
describe('useObservableMap', () => {
    it('should initialize with provided map', () => {
        ...
        const { result } = renderHook(() => useObservableMap(initialMap));
    ...
    it('type have backward compatibility with Map', () => {
        const initialMap = new ObservableMap<string, number>();
        const mapAsState: Map<string, number> = initialMap;
